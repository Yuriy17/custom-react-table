    ...
    <div className="not-found">
      <main>
        <div className="main__wrapper">
          ...
          <h3 className="text-2">sorry :(</h3>

          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
            <g id="freepik--background-complete--inject-1">
              <rect y="382.4" width="500" height="0.25" style={{ fill: '#ebebeb' }} />
              <rect x="428.22" y="398.49" width="21.68" height="0.25" style={{ fill: '#ebebeb' }} />
              <rect x="310.56" y="393.31" width="34.11" height="0.25" style={{ fill: '#ebebeb' }} />
              <rect x="396.59" y="389.21" width="44.53" height="0.25" style={{ fill: '#ebebeb' }} />
              <rect x="161.88" y="394.25" width="11.14" height="0.25" style={{ fill: '#ebebeb' }} />
              <rect x="114.58" y="394.25" width="38.39" height="0.25" style={{ fill: '#ebebeb' }} />
              <rect x="66.31" y="390.03" width="27.7" height="0.25" style={{ fill: '#ebebeb' }} />
              <path
              ...
              <polygon
                ...
                style={{ fill: '#e0e0e0' }}
              />
              <path d="M90,294.13a1.8,1.8,0,0,1,2.54-2.54l-1.91-2.87L88,290l-.56,2.7Z" style={{ fill: '#e0e0e0' }} />
              <path
              ...
              <path
                ...
                style={{ fill: '#f0f0f0' }}
              />
              <path d="M74.11,77.71a4.45,4.45,0,1,1-3,5.78A4.59,4.59,0,0,1,74.11,77.71Z" style={{ fill: '#e0e0e0' }} />
              <rect
                x="74.93"
                y="76.84"
                width="1.37"
            ...
            <g id="freepik--error-404--inject-1">
              ...
              <path d="M411.5,170.67a.82.82,0,1,1-.79-.85A.82.82,0,0,1,411.5,170.67Z" style={{ fill: '#263238' }} />
              <path
                d="M408.17,188a.82.82,0,0,1-.85.79.81.81,0,0,1-.79-.84.82.82,0,0,1,.85-.8A.83.83,0,0,1,408.17,188Z"
                style={{ fill: '#263238' }}
              />
              <path d="M401.61,206a.82.82,0,0,1-1.63,0,.82.82,0,1,1,1.63,0Z" style={{ fill: '#263238' }} />
              <path d="M401.5,222.57a.81.81,0,0,1-.85.79.82.82,0,1,1,.85-.79Z" style={{ fill: '#263238' }} />
              <path d="M398.17,239.87a.82.82,0,1,1-.79-.84A.82.82,0,0,1,398.17,239.87Z" style={{ fill: '#263238' }} />
              <path
                d="M394.84,257.17a.83.83,0,0,1-.85.8.82.82,0,0,1-.79-.85.82.82,0,0,1,1.64.05Z"
                style={{ fill: '#263238' }}
              />
              <path d="M391.5,274.48a.82.82,0,1,1-.79-.85A.81.81,0,0,1,391.5,274.48Z" style={{ fill: '#263238' }} />
              <path
            ...
            <g id="freepik--Character--inject-1">
              <path
                ...
                style={{ fill: '#263238' }}
              />
              <circle cx="251.51" cy="273" r="18.38" style={{ fill: '#fff' }} />
              <path
              ...
              <path
                ...
                style={{ fill: '#263238' }}
              />
              <circle cx="209.88" cy="297.88" r="0.82" style={{ fill: '#263238' }} />
              <path d="M218.21,303.78a.82.82,0,1,1-.82-.82A.82.82,0,0,1,218.21,303.78Z" style={{ fill: '#263238' }} />
              <path d="M219.13,400.68a.82.82,0,1,1-.82-.82A.82.82,0,0,1,219.13,400.68Z" style={{ fill: '#263238' }} />
              <path d="M226.64,406.59a.82.82,0,1,1-.82-.82A.82.82,0,0,1,226.64,406.59Z" style={{ fill: '#263238' }} />
            </g>
            <g id="freepik--robot-parts--inject-1">
              ...
              <polygon
                ...
                style={{ fill: '#407BFF' }}
              />
              <path d="M419.9,412.59a1.82,1.82,0,1,0,0-3.63l3.42-.68.91,2.76-1.52,2.33Z" style={{ fill: '#407BFF' }} />
              <path
